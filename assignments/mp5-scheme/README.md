...
pandoc -s -t latex -o README.pdf README.md \
  --pdf-engine=lualatex \
...
<!-- old
$$ {[\![(\texttt{lambda}\ (p_1 \cdots p_n)\ e) \mid {\sigma}]\!]} {\ \Downarrow \ }{\texttt{Func}}\ p_1 \cdots p_n\ e\ {\sigma}{\ \bigm\vert \ }\mathbf{valid}(p_1 \cdots p_n) $$
-->
...
<!-- old
$$ {[\![(\texttt{lambda}\ (p_1 \cdots p_n)\ e) \mid {\sigma}]\!]} {\ \Downarrow \ }{\texttt{NotASymbol}} {\ \bigm\vert \ }\lnot\, \mathbf{valid}(p_1 \cdots p_n) $$
-->
